...
@InputType()
class FollowerCreateNestedManyWithoutFollowersInput {
...
export { FollowerCreateNestedManyWithoutFollowersInput as FollowerCreateNestedManyWithoutFollowersInput };
